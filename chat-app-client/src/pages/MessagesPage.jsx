  ...
  return (
    <motion.button
      ...
      className={[
        ...
        active ? "bg-[rgba(var(--panel)/0.75)]" : "bg-[rgba(var(--panel)/0.35)]",
        "hover:bg-[rgba(var(--panel)/0.75)]",
        "transition",
      ].join(" ")}
    >
      <img
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center justify-between gap-2">
          ...
          {chatUser.unreadCount > 0 ? (
            <div className="inline-flex h-5 min-w-5 items-center justify-center rounded-full bg-[rgb(var(--primary))] px-1.5 text-[11px] font-bold text-black">
    ...
    <div className="min-h-screen">
      <div className="sticky top-0 z-40 border-b border-white/10 bg-[rgba(var(--panel)/0.45)] backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-3xl items-center gap-3 px-4 py-3">
          ...
          <div>
            ...
            <div className="text-xs text-[rgb(var(--muted))]">Your conversations</div>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto w-full max-w-3xl px-4 py-4">
        {loading && !hasRows ? (
          ...
          <div className="rounded-2xl border border-white/10 bg-[rgba(var(--panel)/0.45)] p-6 text-center backdrop-blur">
            <div className="text-sm font-semibold text-[rgb(var(--text))]">No chats yet</div>
